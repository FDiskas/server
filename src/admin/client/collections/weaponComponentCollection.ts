...
export class WeaponComponentCollection {
    ...
    constructor() {
        ...
        this.components[WeaponHash.CombatPistol] = [
            ...
            {
                key: 'component_combatpistol_varmod_lowrider',
                name: 'wct_var_gold',
            },
        ];
        ...
        this.components[WeaponHash.SNSPistol] = [
            ...
            {
                key: 'component_snspistol_varmod_lowrider',
                name: 'wct_var_wood',
            },
        ];
        ...
        this.components[WeaponHash.PumpShotgun] = [
            ...
            {
                key: 'component_pumpshotgun_varmod_lowrider',
                name: 'wct_var_gold',
            },
        ];
        ...
        this.components[WeaponHash.SawedOffShotgun] = [
            {
                key: 'component_sawnoffshotgun_varmod_luxe',
                name: 'wct_var_metal',
            },
        ];
        ...
        this.components[WeaponHash.AdvancedRifle] = [
            ...
            {
                key: 'component_advancedrifle_varmod_luxe',
                name: 'wct_var_metal',
            },
        ];
        ...
        this.components[WeaponHash.CombatMG] = [
            ...
            {
                key: 'component_combatmg_varmod_lowrider',
                name: 'wct_var_etchm',
            },
        ];
        ...
        this.components[WeaponHash.MarksmanRifle] = [
            ...
            {
                key: 'component_marksmanrifle_varmod_luxe',
                name: 'wct_var_gold',
            },
        ];
