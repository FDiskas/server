    ...
    init() {
        ...
        alt.onServer('player:teleportToEntity', (entity: alt.Entity) =>
            entity instanceof alt.Player && entity.vehicle
                ? game.setPedIntoVehicle(alt.Player.local.scriptID, entity.vehicle.scriptID, VehicleSeat.Free)
                : game.setPedCoordsKeepVehicle(alt.Player.local.scriptID, entity.pos.x, entity.pos.y, entity.pos.z)
        );
    }
