export const enum TaskId {
    ...
    CTaskVehiclePlayerDriveAmphibiousAutomobile = 498,
    CTaskVehiclePlayerDrivePlane = 499,
    CTaskVehiclePlayerDriveHeli = 500,
    CTaskVehiclePlayerDriveAutogyro = 501,
    CTaskVehiclePlayerDriveDiggerArm = 502,
    CTaskVehiclePlayerDriveTrain = 503,
    CTaskVehiclePlaneChase = 504,
    CTaskVehicleNoDriver = 505,
    CTaskVehicleAnimation = 506,
    CTaskVehicleConvertibleRoof = 507,
    CTaskVehicleParkNew = 508,
    CTaskVehicleFollowWaypointRecording = 509,
    CTaskVehicleGoToNavmesh = 510,
    CTaskVehicleReactToCopSiren = 511,
    CTaskVehicleGotoLongRange = 512,
    CTaskVehicleWait = 513,
    CTaskVehicleReverse = 514,
    CTaskVehicleBrake = 515,
    CTaskVehicleHandBrake = 516,
    CTaskVehicleTurn = 517,
    CTaskVehicleGoForward = 518,
    CTaskVehicleSwerve = 519,
    CTaskVehicleFlyDirection = 520,
    CTaskVehicleHeadonCollision = 521,
    CTaskVehicleBoostUseSteeringAngle = 522,
    CTaskVehicleShotTire = 523,
    CTaskVehicleBurnout = 524,
    CTaskVehicleRevEngine = 525,
    CTaskVehicleSurfaceInSubmarine = 526,
    CTaskVehiclePullAlongside = 527,
    CTaskVehicleTransformToSubmarine = 528,
    CTaskAnimatedFallback = 529,
}
